<template>
  <div class="container" style="max-width: 600px">
    ...
    <table class="table table-bordered mt-5">
      <thead>
        <tr>
          <th scope="col text-center" style="">S no.</th>
        ...
        <tr v-for="(task, index) in tasks" :key="index">
          ...
          <td class="text-center">
            <div @click="editTask(index)">
              <p class="fa fa-pen text-green pointer"></p>
            </div>
          </td>
          <td class="text-center">
...
export default {
  ...
  data() {
    return {
      ...
      tasks: [
        {
          name: "Hello my name is UJJWAL",
          status: "to-do",
        },
        {
          name: "I'm creating a vue project",
          status: "in-progress",
        },
        {
          name: "Create Todo App inn vue.",
          status: "finished",
        },
      ],
    };
